...
$config['base_url'] = 'http://localhost/branch/';
//$config['base_url'] = 'http://wified.co/demo/xtragenius_branch/';
...
|
*/
$config['encryption_key'] = 'xtragenStud';
...
$config['sess_cookie_name'] = 'ci_session_Candi';
